...
W_Adep=160e-9; tau_h=W_Adep/4.5e4; W_norm=W+W_Adep
def H_ph(w):
    ...
    return (abs_t+col_t+hole_t)/(W_norm*(1+1j*w*tau_A))
...
Iph=5.0e-3
out='origin_data_5V_5mA_hole'; os.makedirs(out,exist_ok=True)
Z0=50.0
...
fig.suptitle(f'-5 V / 5 mA  |  Cj = {Cj*1e15:.1f} fF (S11 refit; C-V: 161 fF), H_ph with dep-abs hole  |  '
...
fig.tight_layout()
fig.savefig('Eval_5V_hole.png',dpi=150,bbox_inches='tight')
