...
fit={}
print('CASE 5 fit (free: L_CPW, C_CPW)')
...
print(f'  total RMS = {sum(v[1] for v in fit.values()):.5f}   (CASE 4 = 0.33779)')
...
fig.tight_layout(); fig.savefig('case5_smith_7V.png',dpi=170,bbox_inches='tight',facecolor='white')
print('saved case5_smith_7V.png')
...
fig.tight_layout(); fig.savefig('case5_pout_7V.png',dpi=170,bbox_inches='tight',facecolor='white')
print('saved case5_pout_7V.png'); print('BW:',{k:round(v,1) for k,v in bw.items()})
...
mk_note(fig.add_subplot(gs[2]),
    'For reference, holding C_CPW at the 46.53 fF pad value gives a total S11 RMS of 0.3378 versus '
    f'{sum(v[1] for v in fit.values()):.4f} here.')
...
fig.savefig('case5_tables.png',dpi=200,bbox_inches='tight',facecolor='white')
print('saved case5_tables.png')
