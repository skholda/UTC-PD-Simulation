...
Outputs: case4_smith_7V.png, case4_pout_7V.png, case4_tables.png
"""
...
fit={}
print('CASE 4 fit (free: L_CPW only)')
for lbl,Rp,s1pk,frk,Lm,col,xmax in DEV:
    ...
    r=minimize_scalar(cost,bounds=(10,400),method='bounded')
    fit[lbl]=(r.x,r.fun)
...
fig.tight_layout(); fig.savefig('case4_smith_7V.png',dpi=170,bbox_inches='tight',facecolor='white')
print('saved case4_smith_7V.png')
...
fig.tight_layout(); fig.savefig('case4_pout_7V.png',dpi=170,bbox_inches='tight',facecolor='white')
print('saved case4_pout_7V.png'); print('BW:',{k:round(v,1) for k,v in bw.items()})
...
fig.savefig('case4_tables.png',dpi=200,bbox_inches='tight',facecolor='white')
print('saved case4_tables.png')
