...
# electron transit from v(E) integral over actual field (-7V, 0.5mA, lat 10um);
# τ_A kept; hole at saturation:
tau_eD = 3.039e-12                                # dep-abs e (v(E) over 0.74-0.98 um)
tau_C  = 8.953e-12                                # collector e (v(E) over 0-0.74 um)
